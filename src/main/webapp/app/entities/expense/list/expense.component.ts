...
export class ExpenseComponent implements OnInit {
  ...
  trackId = (_index: number, item: IExpense): number => this.expenseService.getExpenseIdentifier(item);
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.expenseService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
