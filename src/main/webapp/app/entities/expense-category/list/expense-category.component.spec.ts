...
describe('ExpenseCategory Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'expense-category', component: ExpenseCategoryComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.expenseCategories?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to expenseCategoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExpenseCategoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getExpenseCategoryIdentifier).toHaveBeenCalledWith(entity);
